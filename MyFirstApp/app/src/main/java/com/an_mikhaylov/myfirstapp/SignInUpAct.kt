...
import com.an_mikhaylov.myfirstapp.databinding.ActivitySignInUpBinding
...
class SignInUpAct : AppCompatActivity() {
    ...
    fun onClickDone(view:View) {
        if (signState == Constance.SIGN_UP_STATE) {
            ...
            if (bindingClass.imAvatar.isVisible)intent.putExtra(Constance.AVATAR, R.drawable.andrey)
