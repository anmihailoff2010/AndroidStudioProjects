package com.an_mikhaylov.voicecommander;
    ...
    private void textCommand(String text) {
        switch (text) {
            ...
            case "протокол самоуничтожения":
                protocolDist();
                break;
            case "Какой самый лучший канал на YouTube":
                textToSpeech.speak("Лучший YouTube канал это конечно канал НЭКО, и не забудь подписаться!! Вот такие дела? Еще что нибудь? Ну тогда пока!",
