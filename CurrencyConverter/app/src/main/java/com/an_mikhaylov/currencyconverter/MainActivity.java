package com.an_mikhaylov.currencyconverter;
...
public class MainActivity extends AppCompatActivity {
    ...
    String[] country = {"USD","EUR","RUB","AUD","AZN","AMD","BYN","BGN","BRL","HUF","KRW","HKD","DKK","INR","KZT","CAD","KGS","CNY","MDL","RON","TMT","NOK","PLN","XDR","SGD","TJS","TRY","UZS","UAH","GBP","CZK","SEK","CHF","ZAR","JPY"};
