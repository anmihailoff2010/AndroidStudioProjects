package com.an_mikhaylov.mytick_tac_toe
...
import com.an_mikhaylov.mytick_tac_toe.databinding.ActivityGameBinding
...
class GameActivity : AppCompatActivity() {
    ...
    private fun makeStepOfAI() : CellGameFiled{
        return when(settingsInfo.lvl) {
            0 -> makeStepOfAI_EasyLvl()
            1 -> makeStepOfAI_MediumLvl()
            2 -> makeStepOfAI_HardLvl()
    ...
    private fun makeStepOfAI_HardLvl() : CellGameFiled {
    ...
    private fun makeStepOfAI_MediumLvl() : CellGameFiled {
        var bestScore = Double.NEGATIVE_INFINITY
        var move = CellGameFiled(0, 0)
    ...
    private fun makeStepOfAI_EasyLvl() :CellGameFiled {
        var randRow = 0
        var randColumn = 0
